...
// A new constructor to load yaml directly (without ros) -> this was necessary so that all the classes (e.g. Session) also inherit the parameters loaded from the yaml file
//RosParamServer::RosParamServer()
//        : nh(nh_super) {
//    load_params("../../../../config/params.yaml");
//}
//
//void RosParamServer::load_params(const std::string& configPath)
//{
//
//    try {
//
